...
# リブ種類
fullribnum = [2,4,6,8,10,11,13,15,17,19] # fullribのリブ番号
harfribnum = [3,5,7,9,12,14,16,18] # halfribのリブ番号
endribnum = [1,20] # endribのリブ番号
