...
use_half = False
# リブ種類
fullnum = 42 #便宜上つけた消していいよ
fullribnum = list(range(9,fullnum)) # fullribのリブ番号
harfribnum = list(range(fullnum,n+1)) # halfribのリブ番号
endribnum = list(range(1,9)) # endribのリブ番号
...
nikunukiBasePoint_d7_Kouenn_YokuatuRate = 0.23
nikunukiBasePoint_d8_Kouenn_YokuatuRate = 0.25
# 機体諸元
# 0翼取り付け角[°](定常飛行迎角)
alpha = 0
# 後退角(リブ厚みの修正用)[°]
...
for k in range(1, n + 1):  # range(1,n+1):				 	#根から k 枚目のリブ
    ...
    sannkakuObjectList = [
        ...
        makeSannkakuNikunukiObject(
            ...
            convertYokugennRateGaishuuyohakuToZahyou(
                nikunukiBasePoint_d6_Zenenn, nikunukiBasePoint_d6_Zenenn_YokuatuRate
            ),
        ),
        makeSannkakuNikunukiObject(
            convertYokugennRateGaishuuyohakuToZahyou(
        ...
        makeSannkakuNikunukiObject(
            ...
            convertYokugennRateGaishuuyohakuToZahyou(
                nikunukiBasePoint_d8_Kouenn, nikunukiBasePoint_d8_Kouenn_YokuatuRate
            ),
        ),
    ]
