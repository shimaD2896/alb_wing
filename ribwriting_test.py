...
# 後縁側上面
# 後縁側d1が動く設定になっている
nikunukiBasePoint_u1_Kouenn = 47.5
nikunukiBasePoint_u2_Kouenn = 49.5
nikunukiBasePoint_u3_Kouenn = 58
nikunukiBasePoint_u4_Kouenn = 60
nikunukiBasePoint_u5_Kouenn = 62
nikunukiBasePoint_u6_Kouenn = 69
nikunukiBasePoint_u7_Kouenn = 71
# 後縁側下面
nikunukiBasePoint_d1_Kouenn = 43
nikunukiBasePoint_d2_Kouenn = 52.5
nikunukiBasePoint_d3_Kouenn = 54.5
nikunukiBasePoint_d4_Kouenn = 56.5
nikunukiBasePoint_d5_Kouenn = 64
nikunukiBasePoint_d6_Kouenn = 66
nikunukiBasePoint_d7_Kouenn = 68
nikunukiBasePoint_d8_Kouenn = 75
...
sannkakunukunuki_base_move_y_u1_kouenn = -0.20
sannkakunukunuki_base_move_y_u2_kouenn = -0.20
sannkakunukunuki_base_move_y_u3_kouenn = -0.20
sannkakunukunuki_base_move_y_u4_kouenn = -0.20
sannkakunukunuki_base_move_y_u5_kouenn = -0.20
sannkakunukunuki_base_move_y_u6_kouenn = -0.20
sannkakunukunuki_base_move_y_u7_kouenn = -0.20
sannkakunukunuki_base_move_y_d1_kouenn = 0.20
sannkakunukunuki_base_move_y_d2_kouenn = 0.20
sannkakunukunuki_base_move_y_d3_kouenn = 0.20
sannkakunukunuki_base_move_y_d4_kouenn = 0.20
sannkakunukunuki_base_move_y_d5_kouenn = 0.20
sannkakunukunuki_base_move_y_d6_kouenn = 0.20
sannkakunukunuki_base_move_y_d7_kouenn = 0.23
sannkakunukunuki_base_move_y_d8_kouenn = 0.25
...
for k in range(1, n + 1):  # range(1,n+1):				 	#根から k 枚目のリブ
    ...
    # ストリンガーの出力
    StringerU = stringer(RibCap_uPs[-1], RibCap_uPs[-2], tp, R=True)
    StringerDL = stringer(
    ...
    #PlankPs = (
    #    [div_P2(StringerU.A, StringerU.D, tp/e1)] + PlankPs + [StringerDL.A]
    #)  # 端点をストリンガーの頂点と一致させる。
    ...
    def makeSannkakuNinuki(file, sannkakuNikunukiObject):     
        ...
        r = abs((sannkakuNikunukiObject["basepoint_1_vec"] + sannkakuNikunukiObject["basepoint_2_vec"] + sannkakuNikunukiObject["basepoint_3_vec"])/3 - sannkakuNikunukiObject["basepoint_1_vec"])/6
    ...
    if k not in halfRibNumber:
        ...
        sankakkeiObject_9 = makeSannkakuNikunukiObject(
            ...
            convertYokugennRateGaishuuyohakuToZahyou(
                nikunukiBasePoint_d8_Kouenn, sannkakunukunuki_base_move_y_d8_kouenn
            ),
        )
